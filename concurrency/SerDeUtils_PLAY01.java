 ...
 *
 */
public final class SerDeUtils_PLAY01 {
  ...
  private static Map<String, Class<?>> serdesPlay01 = null;
  
  private static Map<String, Class<?>> serdesPlay02 = new ConcurrentHashMap<String, Class<?>>();;
  ...
  public static void registerSerDePlay01(String name, Class<?> serde) {
      if (serdesPlay01.containsKey(name)) {
        throw new RuntimeException("double registering serde " + name);
      }
      serdesPlay01.put(name, serde);
    }
