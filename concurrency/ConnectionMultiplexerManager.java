...
public class ConnectionMultiplexerManager implements SessionEventListener {
     ...
     */
    /*** BEGIN amazon modifications (Security fix: Insecure randomness) ***/
    private static Random randGen = new SecureRandom();
    /*** END amazon modifications (Security fix: Insecure randomness) ***/
    ...
    public boolean createClientSession(String connectionManagerDomain, String streamID, String hostName, String hostAddress) {
        ...
        if (address == null || LocalClientSession.isAllowed(connection)) {
            ...
            /*** BEGIN amazon modifications (DCL Security fix ***/
            Map<String, LocalClientSession> sessions;
            ...
            /*** END amazon modifications (DCL Security fix ***/
