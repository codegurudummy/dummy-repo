...
public class LandingTemplateRegistration
{
    ...
    {
        // __ADI__ I have this LandingTemplateRegistration to show that, if the throw statement does NOT
        //      post-dominate its branch, the messaging will not mention it
        //  Note that, by how I shaped the outer IF, templates.containsKey(name) still controls the templates.put(name, template);
        if (templates.containsKey(name))
        {
            if(name.startsWith("lala")) {
