...
public class DatanodeDescriptor extends DatanodeInfo {
  public static final Logger LOG =
      LoggerFactory.getLogger(org.apache.hadoop.hdfs.server.blockmanagement.DatanodeDescriptor.class);
  public static final org.apache.hadoop.hdfs.server.blockmanagement.DatanodeDescriptor[] EMPTY_ARRAY = {};
  ...
  public static class CachedBlocksList extends IntrusiveCollection<CachedBlock> {
    ...
    private final org.apache.hadoop.hdfs.server.blockmanagement.DatanodeDescriptor datanode;

    private final Type type;

    CachedBlocksList(org.apache.hadoop.hdfs.server.blockmanagement.DatanodeDescriptor datanode, Type type) {
  ...
  void addBlockToBeErasureCoded(ExtendedBlock block,
                                org.apache.hadoop.hdfs.server.blockmanagement.DatanodeDescriptor[] sources, DatanodeStorageInfo[] targets,
