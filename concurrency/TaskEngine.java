...
import com.amazon.campfire.util.LoggingThreadPoolExecutor;
...
//*** BEGIN amazon ***
        ...
        // Create an executor that logs errors.
        // Constructor parameters stolen from Executors.newCachedThreadPool source from openjdk
        // See http://grepcode.com/file/repository.grepcode.com/java/root/jdk/openjdk/8u40-b25/java/util/concurrent/Executors.java?av=f#230
        executor = new LoggingThreadPoolExecutor(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), threadFactory);
//*** END amazon ***
    }
