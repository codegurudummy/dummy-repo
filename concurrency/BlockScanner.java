...
public class BlockScanner {
  public static final Logger LOG =
      LoggerFactory.getLogger(org.apache.hadoop.hdfs.server.datanode.BlockScanner.class);
  ...
  // Adrian added tis.  it shows that the comment from the Conf class does not leak outside
  //    we had some problem in the past where that happened
  void setConfShouldGetReported() {
//    this.conf = conf;
    for (Entry<String, VolumeScanner> entry : scanners.entrySet()) {
  ...
  */
  ...
  public static class Servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
      ...
      org.apache.hadoop.hdfs.server.datanode.BlockScanner blockScanner = datanode.getBlockScanner();
