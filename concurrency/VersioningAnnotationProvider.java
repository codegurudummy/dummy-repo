...
public class VersioningAnnotationProvider {
    ...
    public Image annotateIcon(Image icon, int iconType, Set<? extends FileObject> files) {
        ...
        if (ANNOTATOR_ASYNC) {
            ...
            annotatedIcon = iconCache.getValue(iconCache.new ItemKey(files, "", files instanceof NonRecursiveFolder, EMPTY_ICON)); //NOI18N
            ...
            annotatedIcon = iconCache.getValue(iconCache.new ItemKey(files, "", files instanceof NonRecursiveFolder, icon)); //NOI18N
        }
        return annotatedIcon;
    }

    public String annotateNameHtml(String name, Set<? extends FileObject> files) {
        String annotatedName = labelCache.getValue(labelCache.new ItemKey(files, name, files instanceof NonRecursiveFolder, name));
